...
DEFAULT_SPEECH_TO_TEXT_PROMPT = (
    ...
    "   - **សំខាន់បំផុត:** ប្រសិនបើមានឧទាហរណ៍កូដ (Code C++, Python, HTML, Java, etc.) ដាច់ខាតត្រូវតែស្រោបកូដក្នុង Markdown Code Block ជាមួយឈ្មោះភាសា (ឧទាហរណ៍ ```cpp ... ```) ជានិច្ច!\n\n"
    "**សូមរៀបចំទម្រង់ឆ្លើយតបជាទម្រង់ស្អាត ខ្លីខ្លឹម ដូចខាងក្រោម (ដាច់ខាតមិនត្រូវដាក់ Header ស្ទួន ឬ Tags ឡើយ)៖**\n\n"
    "📝 **លទ្ធផលបំប្លែងសំឡេង៖**\n\n"
    "💬 **អត្ថបទដែលបាននិយាយ៖**\n"
    "\" [ សរសេរអត្ថបទពេញលេញដែលបំប្លែងចេញពីសំឡេងនៅទីនេះ ] \"\n\n"
    "🤖 **ចម្លើយ AI៖**\n"
    "[ សរសេរចម្លើយបកស្រាយ និងឧទាហរណ៍កូដក្នុង Code Block នៅទីនេះ ]\n\n"
    "💡 **ចំណុចសំខាន់ៗដែលត្រូវដឹង៖**\n"
    "• [ ចំណុចសំខាន់ ១ ]\n"
    "• [ ចំណុចសំខាន់ ២ ]\n\n"
    "🔗 **ប្រភព និងឯកសារយោង៖**\n"
    "• 🌐 [Google Search](https://www.google.com)\n"
    "• 📖 [Documentation](https://cppreference.com)"
)
